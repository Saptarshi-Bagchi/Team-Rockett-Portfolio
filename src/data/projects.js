const projects = [
  { id: 'line-follower', title: 'Line Follower', description: 'I have no idea what happened. I was not even there man...', tech: ['Hardware', 'Technology', 'Science', 'Magic'], image: '/project-1.jpg', links: { live: '#', source: '#' } },
